...
public class TerminalDialog extends AppCompatDialog implements View.OnClickListener, ShellUtils.Result {
    ...
    public TerminalDialog(Context context) {
        ...
        params.height = (int) (context.getResources().getDisplayMetrics().heightPixels * 0.7);
        params.width = (int) (context.getResources().getDisplayMetrics().widthPixels * 0.9);
        getWindow().setAttributes(params);
        close.setOnClickListener(this);
        output.setTypeface(Typeface.MONOSPACE);
        output.setTextSize(TypedValue.COMPLEX_UNIT_SP, 24 / context.getResources().getDisplayMetrics().scaledDensity);
    }
    ...
    public void onFinish(final int resultCode) {
        isFinish = true;
        SpannableString str = new SpannableString(getActivity().getString(R.string.result_code) + " : " + resultCode + "\n");
